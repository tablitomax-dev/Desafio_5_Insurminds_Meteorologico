...
|---|---|---|---|---|
| `story-01-collect-open-meteo` | Coleta Open-Meteo por segurado | weather-monitoring | done | P1 |
| `story-02-heavy-rain-residential` | Chuva intensa → residencial | risk-detection | done | P0 |
